...
//DKS - Disabled... I think this is for older weird OS2 sound stuff or something
//DKS - re-enabled after compile problems
...
extern unsigned int     control[MAXROCKETS];
...
extern SDL_Surface *bball_bitmap, *apple_bitmap, *inspector_bitmap, *mouse_bitmap,
                *lunatic_bitmap, *lball_bitmap[NLETTERS], *circle_bitmap,
                *hole_bitmap, *ehole_bitmap, *ball_bitmap, *eye_bitmap[MAXROCKETS],
                *rocket_bitmap[MAXROCKETS];

//DKS - original, changed for aligned-access platforms
