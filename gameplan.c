...
//  ClearScreen ();
  ClearScreen(physicalscreen);

  tbreak = 1;

#ifdef GCW
  //DKS - generate new plasma background
  drawbackground();
#endif
...
//#endif
  //DKS fixed centering
  //DrawWhiteMaskedText (physicalscreen, MAPWIDTH / 2 - 32, MAPHEIGHT / 2 - 4, s);
  DrawWhiteMaskedText (physicalscreen, MAPWIDTH / 2 - strlen(s) * 4 , MAPHEIGHT / 2 - 4, s);
...
init_objects ()
{
  switch (difficulty)
    {
    case 0:
		 //DKS - NIGHTMARE mode is just unplayable, I am adjusting to a good challenging setting.
		 //DKS - .8 for ROCKET_SPEED is too slow-paced and not fun
//      ROCKET_SPEED = 0.8; 
      ROCKET_SPEED = 1.0;
		//DKS - instead, we'll adjust thse to be a bit faster:
//      BALL_SPEED = 1.2;
//      BBALL_SPEED = 1.2;
      BALL_SPEED = 1.3;
      BBALL_SPEED = 1.3;
      ...
      BBALLM = 8;
      APPLEM = 40;
		//DKS - 2 for ROCKETM is WAAAY too difficult
//      ROCKETM = 2;
      ROCKETM = 3.25;
      break;
    case 1:
      ...
      BBALLM = 8;
      APPLEM = 40;
		//DKS for hard difficulty level, 4 is too easy
//      ROCKETM = 4;
      ROCKETM = 3.6;
    ...
    case 2:
      ...
      BALL_SPEED = 1.2;
      BBALL_SPEED = 1.2;
		//DKS - WAYYY TO SLOW to be any fun:
//      SLOWDOWN = 0.8;
      SLOWDOWN = 0.9;
      GUMM = 20;
